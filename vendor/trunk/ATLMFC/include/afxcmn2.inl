...
#else
_AFXCMN_INLINE CImageList* CHeaderCtrl::GetImageList(_In_ int /* nImageListIgnored */) const
	{ ASSERT(::IsWindow(m_hWnd)); return CImageList::FromHandle((HIMAGELIST) ::SendMessage(m_hWnd, HDM_GETIMAGELIST, 0, 0L)); }
_AFXCMN_INLINE CImageList* CHeaderCtrl::SetImageList(CImageList* pImageList, _In_ int /*nImageListIgnored*/)
...
#if (_WIN32_WINNT >= 0x600) && defined(UNICODE) && !defined(_WIN32_WCE)
...
#endif // _WIN32_WINNT >= 0x600 && defined(UNICODE) && !defined(_WIN32_WCE)
...
//_AFXCMN_INLINE void CReBarCtrl::SetToolTips(CToolTipCtrl* pTip)
//	{ ASSERT(::IsWindow(m_hWnd)); ::SendMessage(m_hWnd, RB_SETTOOLTIPS, (WPARAM)pTip->m_hWnd, 0L); }
//#endif //!#ifndef _WIN32_WCE_NO_TOOLTIPS
...
#if (_WIN32_WINNT >= 0x0600) && defined(UNICODE) && !defined(_WIN32_WCE)
...
#endif // _WIN32_WINNT >= 0x0600 && defined(UNICODE) && !defined(_WIN32_WCE)
...
#if (_WIN32_WINNT >= 0x0501) && defined(UNICODE) && !defined(_WIN32_WCE)
