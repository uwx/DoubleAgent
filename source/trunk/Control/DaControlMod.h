...
_COM_SMARTPTR_TYPEDEF (IDaCtlCharacter3, __uuidof(IDaCtlCharacter3));
...
_COM_SMARTPTR_TYPEDEF (IDaCtlTTSPrivate, __uuidof(IDaCtlTTSPrivate));
...
_COM_SMARTPTR_TYPEDEF (IDaSvrCharacter3, __uuidof(IDaSvrCharacter3));
...
_COM_SMARTPTR_TYPEDEF (IDaSvrTTSPrivate, __uuidof(IDaSvrTTSPrivate));
