...
// CAgentEx wrapper class

class CAgentEx : public COleDispatchDriver
{
public:
	CAgentEx(){} // Calls COleDispatchDriver default constructor
	CAgentEx(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAgentEx(const CAgentEx& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
