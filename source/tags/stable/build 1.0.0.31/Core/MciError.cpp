...
LPCTSTR _GetMciErr (MMRESULT pError)
{
	LPCTSTR	lError = NULL;

	switch (pError)
	{
		case MCIERR_INVALID_DEVICE_ID:					lError = _T("MCIERR_INVALID_DEVICE_ID"); break;
		case MCIERR_UNRECOGNIZED_KEYWORD:				lError = _T("MCIERR_UNRECOGNIZED_KEYWORD"); break;
		case MCIERR_UNRECOGNIZED_COMMAND:				lError = _T("MCIERR_UNRECOGNIZED_COMMAND"); break;
		case MCIERR_HARDWARE:							lError = _T("MCIERR_HARDWARE"); break;
		case MCIERR_INVALID_DEVICE_NAME:				lError = _T("MCIERR_INVALID_DEVICE_NAME"); break;
		case MCIERR_OUT_OF_MEMORY:						lError = _T("MCIERR_OUT_OF_MEMORY"); break;
		case MCIERR_DEVICE_OPEN:						lError = _T("MCIERR_DEVICE_OPEN"); break;
		case MCIERR_CANNOT_LOAD_DRIVER:					lError = _T("MCIERR_CANNOT_LOAD_DRIVER"); break;
		case MCIERR_MISSING_COMMAND_STRING:				lError = _T("MCIERR_MISSING_COMMAND_STRING"); break;
		case MCIERR_PARAM_OVERFLOW:						lError = _T("MCIERR_PARAM_OVERFLOW"); break;
		case MCIERR_MISSING_STRING_ARGUMENT:			lError = _T("MCIERR_MISSING_STRING_ARGUMENT"); break;
		case MCIERR_BAD_INTEGER:						lError = _T("MCIERR_BAD_INTEGER"); break;
		case MCIERR_PARSER_INTERNAL:					lError = _T("MCIERR_PARSER_INTERNAL"); break;
		case MCIERR_DRIVER_INTERNAL:					lError = _T("MCIERR_DRIVER_INTERNAL"); break;
		case MCIERR_MISSING_PARAMETER:					lError = _T("MCIERR_MISSING_PARAMETER"); break;
		case MCIERR_UNSUPPORTED_FUNCTION:				lError = _T("MCIERR_UNSUPPORTED_FUNCTION"); break;
		case MCIERR_FILE_NOT_FOUND:						lError = _T("MCIERR_FILE_NOT_FOUND"); break;
		case MCIERR_DEVICE_NOT_READY:					lError = _T("MCIERR_DEVICE_NOT_READY"); break;
		case MCIERR_INTERNAL:							lError = _T("MCIERR_INTERNAL"); break;
		case MCIERR_DRIVER:								lError = _T("MCIERR_DRIVER"); break;
		case MCIERR_CANNOT_USE_ALL:						lError = _T("MCIERR_CANNOT_USE_ALL"); break;
		case MCIERR_MULTIPLE:							lError = _T("MCIERR_MULTIPLE"); break;
		case MCIERR_EXTENSION_NOT_FOUND:				lError = _T("MCIERR_EXTENSION_NOT_FOUND"); break;
		case MCIERR_OUTOFRANGE:							lError = _T("MCIERR_OUTOFRANGE"); break;
		case MCIERR_FLAGS_NOT_COMPATIBLE:				lError = _T("MCIERR_FLAGS_NOT_COMPATIBLE"); break;
		case MCIERR_FILE_NOT_SAVED:						lError = _T("MCIERR_FILE_NOT_SAVED"); break;
		case MCIERR_DEVICE_TYPE_REQUIRED:				lError = _T("MCIERR_DEVICE_TYPE_REQUIRED"); break;
		case MCIERR_DEVICE_LOCKED:						lError = _T("MCIERR_DEVICE_LOCKED"); break;
		case MCIERR_DUPLICATE_ALIAS:					lError = _T("MCIERR_DUPLICATE_ALIAS"); break;
		case MCIERR_BAD_CONSTANT:						lError = _T("MCIERR_BAD_CONSTANT"); break;
		case MCIERR_MUST_USE_SHAREABLE:					lError = _T("MCIERR_MUST_USE_SHAREABLE"); break;
		case MCIERR_MISSING_DEVICE_NAME:				lError = _T("MCIERR_MISSING_DEVICE_NAME"); break;
		case MCIERR_BAD_TIME_FORMAT:					lError = _T("MCIERR_BAD_TIME_FORMAT"); break;
		case MCIERR_NO_CLOSING_QUOTE:					lError = _T("MCIERR_NO_CLOSING_QUOTE"); break;
		case MCIERR_DUPLICATE_FLAGS:					lError = _T("MCIERR_DUPLICATE_FLAGS"); break;
		case MCIERR_INVALID_FILE:						lError = _T("MCIERR_INVALID_FILE"); break;
		case MCIERR_NULL_PARAMETER_BLOCK:				lError = _T("MCIERR_NULL_PARAMETER_BLOCK"); break;
		case MCIERR_UNNAMED_RESOURCE:					lError = _T("MCIERR_UNNAMED_RESOURCE"); break;
		case MCIERR_NEW_REQUIRES_ALIAS:					lError = _T("MCIERR_NEW_REQUIRES_ALIAS"); break;
		case MCIERR_NOTIFY_ON_AUTO_OPEN:				lError = _T("MCIERR_NOTIFY_ON_AUTO_OPEN"); break;
		case MCIERR_NO_ELEMENT_ALLOWED:					lError = _T("MCIERR_NO_ELEMENT_ALLOWED"); break;
		case MCIERR_NONAPPLICABLE_FUNCTION:				lError = _T("MCIERR_NONAPPLICABLE_FUNCTION"); break;
		case MCIERR_ILLEGAL_FOR_AUTO_OPEN:				lError = _T("MCIERR_ILLEGAL_FOR_AUTO_OPEN"); break;
		case MCIERR_FILENAME_REQUIRED:					lError = _T("MCIERR_FILENAME_REQUIRED"); break;
		case MCIERR_EXTRA_CHARACTERS:					lError = _T("MCIERR_EXTRA_CHARACTERS"); break;
		case MCIERR_DEVICE_NOT_INSTALLED:				lError = _T("MCIERR_DEVICE_NOT_INSTALLED"); break;
		case MCIERR_GET_CD:								lError = _T("MCIERR_GET_CD"); break;
		case MCIERR_SET_CD:								lError = _T("MCIERR_SET_CD:"); break;
		case MCIERR_SET_DRIVE:							lError = _T("MCIERR_SET_DRIVE"); break;
		case MCIERR_DEVICE_LENGTH:						lError = _T("MCIERR_DEVICE_LENGTH"); break;
		case MCIERR_DEVICE_ORD_LENGTH:					lError = _T("MCIERR_DEVICE_ORD_LENGTH:"); break;
		case MCIERR_NO_INTEGER:							lError = _T("MCIERR_NO_INTEGER"); break;
		case MCIERR_WAVE_OUTPUTSINUSE:					lError = _T("MCIERR_WAVE_OUTPUTSINUSE"); break;
		case MCIERR_WAVE_SETOUTPUTINUSE:				lError = _T("MCIERR_WAVE_SETOUTPUTINUSE"); break;
		case MCIERR_WAVE_INPUTSINUSE:					lError = _T("MCIERR_WAVE_INPUTSINUSE"); break;
		case MCIERR_WAVE_SETINPUTINUSE:					lError = _T("MCIERR_WAVE_SETINPUTINUSE"); break;
		case MCIERR_WAVE_OUTPUTUNSPECIFIED:				lError = _T("MCIERR_WAVE_OUTPUTUNSPECIFIED"); break;
		case MCIERR_WAVE_INPUTUNSPECIFIED:				lError = _T("MCIERR_WAVE_INPUTUNSPECIFIED"); break;
		case MCIERR_WAVE_OUTPUTSUNSUITABLE:				lError = _T("MCIERR_WAVE_OUTPUTSUNSUITABLE"); break;
		case MCIERR_WAVE_SETOUTPUTUNSUITABLE:			lError = _T("MCIERR_WAVE_SETOUTPUTUNSUITABLE"); break;
		case MCIERR_WAVE_INPUTSUNSUITABLE:				lError = _T("MCIERR_WAVE_INPUTSUNSUITABLE"); break;
		case MCIERR_WAVE_SETINPUTUNSUITABLE:			lError = _T("MCIERR_WAVE_SETINPUTUNSUITABLE"); break;
		case MCIERR_SEQ_DIV_INCOMPATIBLE:				lError = _T("MCIERR_SEQ_DIV_INCOMPATIBLE"); break;
		case MCIERR_SEQ_PORT_INUSE:						lError = _T("MCIERR_SEQ_PORT_INUSE"); break;
		case MCIERR_SEQ_PORT_NONEXISTENT:				lError = _T("MCIERR_SEQ_PORT_NONEXISTENT"); break;
		case MCIERR_SEQ_PORT_MAPNODEVICE:				lError = _T("MCIERR_SEQ_PORT_MAPNODEVICE"); break;
		case MCIERR_SEQ_PORT_MISCERROR:					lError = _T("MCIERR_SEQ_PORT_MISCERROR"); break;
		case MCIERR_SEQ_TIMER:							lError = _T("MCIERR_SEQ_TIMER"); break;
		case MCIERR_SEQ_PORTUNSPECIFIED:				lError = _T("MCIERR_SEQ_PORTUNSPECIFIED"); break;
		case MCIERR_SEQ_NOMIDIPRESENT:					lError = _T("MCIERR_SEQ_NOMIDIPRESENT"); break;
		case MCIERR_NO_WINDOW:							lError = _T("MCIERR_NO_WINDOW"); break;
		case MCIERR_CREATEWINDOW:						lError = _T("MCIERR_CREATEWINDOW"); break;
		case MCIERR_FILE_READ:							lError = _T("MCIERR_FILE_READ"); break;
		case MCIERR_FILE_WRITE:							lError = _T("MCIERR_FILE_WRITE"); break;
		case MCIERR_NO_IDENTITY:						lError = _T("MCIERR_NO_IDENTITY"); break;

		case AVIERR_UNSUPPORTED:						lError = _T("AVIERR_UNSUPPORTED"); break;
		case AVIERR_BADFORMAT:							lError = _T("AVIERR_BADFORMAT"); break;
		case AVIERR_MEMORY:								lError = _T("AVIERR_MEMORY"); break;
		case AVIERR_INTERNAL:							lError = _T("AVIERR_INTERNAL"); break;
		case AVIERR_BADFLAGS:							lError = _T("AVIERR_BADFLAGS"); break;
		case AVIERR_BADPARAM:							lError = _T("AVIERR_BADPARAM"); break;
		case AVIERR_BADSIZE:							lError = _T("AVIERR_BADSIZE"); break;
		case AVIERR_BADHANDLE:							lError = _T("AVIERR_BADHANDLE"); break;
		case AVIERR_FILEREAD:							lError = _T("AVIERR_FILEREAD"); break;
		case AVIERR_FILEWRITE:							lError = _T("AVIERR_FILEWRITE"); break;
		case AVIERR_FILEOPEN:							lError = _T("AVIERR_FILEOPEN"); break;
		case AVIERR_COMPRESSOR:							lError = _T("AVIERR_COMPRESSOR"); break;
		case AVIERR_NOCOMPRESSOR:						lError = _T("AVIERR_NOCOMPRESSOR"); break;
		case AVIERR_READONLY:							lError = _T("AVIERR_READONLY"); break;
		case AVIERR_NODATA:								lError = _T("AVIERR_NODATA"); break;
		case AVIERR_BUFFERTOOSMALL:						lError = _T("AVIERR_BUFFERTOOSMALL"); break;
		case AVIERR_CANTCOMPRESS:						lError = _T("AVIERR_CANTCOMPRESS"); break;
		case AVIERR_USERABORT:							lError = _T("AVIERR_USERABORT"); break;
		case AVIERR_ERROR:								lError = _T("AVIERR_ERROR"); break;
...
MMRESULT LogMciErr (unsigned int pLogLevel, MMRESULT pError, LPCTSTR pFormat, ...)
#else
extern "C" void _LogPrepFileLine (LPTSTR pString, LPCSTR pFile, UINT pLine);
MMRESULT _LogMciErrFL::LogErr (unsigned int pLogLevel, MMRESULT pError, LPCTSTR pFormat, ...)
#endif
{
	if	(
			(
		...
		)
	{
		try
		{
			...
			{
				lError = _GetMciErr (pError);
			}

			if	(lError)
			{
				_tcscpy (lFormat, _T("MciError [%8.8X] [%s]"));
			}
			else
			{
				_tcscpy (lFormat, _T(""));
