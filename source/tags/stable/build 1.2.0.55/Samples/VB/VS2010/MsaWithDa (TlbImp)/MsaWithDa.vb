...
Friend Class MsaWithDa
    ...
    Private Sub mDaAgentControl_HideEvent(sender As System.Object, e As AxDoubleAgentCtl._DaCtlEvents2_HideEvent) Handles mDaAgentControl.HideEvent
        SetDaControlButtons()
    End Sub

    Private Sub mDaAgentControl_ShowEvent(sender As System.Object, e As AxDoubleAgentCtl._DaCtlEvents2_ShowEvent) Handles mDaAgentControl.ShowEvent
        SetDaControlButtons()
    End Sub
