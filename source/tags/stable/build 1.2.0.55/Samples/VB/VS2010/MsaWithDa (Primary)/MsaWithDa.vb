...
Friend Class MsaWithDa
    ...
    Private Sub Sample1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        SetMsControlButtons()
        SetMsServerButtons()
        SetDaControlButtons()
        SetDaServerButtons()
    ...
    Private Sub Sample1_FormClosed(sender As System.Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub mDaAgentControl_Hide(sender As System.Object, e As DoubleAgent.AxControl.CtlHideEvent) Handles mDaAgentControl.CtlHide
        SetDaControlButtons()
    End Sub

    Private Sub mDaAgentControl_Show(sender As System.Object, e As DoubleAgent.AxControl.CtlShowEvent) Handles mDaAgentControl.CtlShow
        SetDaControlButtons()
    End Sub
    ...
    Private Sub mDaServer_VisibleState(CharacterID As Integer, Visible As Integer, Cause As Integer) Handles mDaServer.VisibleState
        SetDaServerButtons()
    End Sub
