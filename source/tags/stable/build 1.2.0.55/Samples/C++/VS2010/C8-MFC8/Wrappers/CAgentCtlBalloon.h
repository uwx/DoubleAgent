...
// CAgentCtlBalloon wrapper class

class CAgentCtlBalloon : public COleDispatchDriver
{
public:
	CAgentCtlBalloon(){} // Calls COleDispatchDriver default constructor
	CAgentCtlBalloon(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAgentCtlBalloon(const CAgentCtlBalloon& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
