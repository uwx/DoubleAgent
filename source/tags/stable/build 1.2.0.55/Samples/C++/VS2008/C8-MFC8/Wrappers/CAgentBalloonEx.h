...
// CAgentBalloonEx wrapper class

class CAgentBalloonEx : public COleDispatchDriver
{
public:
	CAgentBalloonEx(){} // Calls COleDispatchDriver default constructor
	CAgentBalloonEx(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAgentBalloonEx(const CAgentBalloonEx& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
