...
#define	ICON_SHOW_WHEN_ACTIVE	( 0x1 )
...
#define	ICON_GENERATE_ALWAYS	( 0x20 )

#define	ICON_IDENTITY_GLOBAL	( 0x100 )

#define	ICON_IDENTITY_CHARACTER	( 0x200 )

#define	ICON_IDENTITY_CLIENT	( 0x300 )
