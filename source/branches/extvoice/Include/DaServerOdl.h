...
#define	DISPID_IDaServer2_GetSpeechEngines	( 0x60040001 )

#define	DISPID_IDaServer2_FindSpeechEngines	( 0x60040002 )

#define	DISPID_IDaServer2_GetCharacterSpeechEngine	( 0x60040003 )

#define	DISPID_IDaServer2_FindCharacterSpeechEngines	( 0x60040004 )

#define	DISPID_IDaServer2_GetRecognitionEngines	( 0x60040005 )

#define	DISPID_IDaServer2_FindRecognitionEngines	( 0x60040006 )

#define	DISPID_IDaServer2_GetCharacterRecognitionEngine	( 0x60040007 )

#define	DISPID_IDaServer2_FindCharacterRecognitionEngines	( 0x60040008 )

#define	DISPID_IDaSvrCharacter2_GetSpeechEngine	( 0x60040000 )

#define	DISPID_IDaSvrCharacter2_FindSpeechEngines	( 0x60040001 )

#define	DISPID_IDaSvrCharacter2_GetRecognitionEngine	( 0x60040002 )

#define	DISPID_IDaSvrCharacter2_FindRecognitionEngines	( 0x60040003 )
