...
namespace AgentCharacterEditor.Updates
{
	internal abstract class UndoableUpdate : UndoUnit
	{
		...
		public CharacterFile CharacterFile
		{
			get
			{
				return Program.MainWindow.CharacterFile;
			}
		}
		...
		public virtual Boolean PutUndo (Object pSource)
		{
			...
			{
				Program.MainWindow.FileIsDirty ();
			}
		...
		{
			return String.Format (AppResources.Resources.UndoDescription, this.ActionDescription.Trim (), this.TargetDescription.Trim (), this.ChangeDescription.Trim ()).Trim ();
		}
#if DEBUG
