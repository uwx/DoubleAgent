...
// CDaCtlUserInput wrapper class

class CDaCtlUserInput : public COleDispatchDriver
{
public:
	CDaCtlUserInput(){} // Calls COleDispatchDriver default constructor
	CDaCtlUserInput(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDaCtlUserInput(const CDaCtlUserInput& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
