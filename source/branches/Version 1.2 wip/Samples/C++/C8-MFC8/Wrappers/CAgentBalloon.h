...
// CAgentBalloon wrapper class

class CAgentBalloon : public COleDispatchDriver
{
public:
	CAgentBalloon(){} // Calls COleDispatchDriver default constructor
	CAgentBalloon(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAgentBalloon(const CAgentBalloon& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
