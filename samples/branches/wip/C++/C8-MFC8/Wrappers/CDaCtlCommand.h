...
// CDaCtlCommand wrapper class

class CDaCtlCommand : public COleDispatchDriver
{
public:
	CDaCtlCommand(){} // Calls COleDispatchDriver default constructor
	CDaCtlCommand(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDaCtlCommand(const CDaCtlCommand& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void put_Confidence(long newValue)
	{
