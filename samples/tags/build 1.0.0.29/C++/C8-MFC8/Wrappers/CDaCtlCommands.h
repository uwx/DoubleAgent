...
// CDaCtlCommands wrapper class

class CDaCtlCommands : public COleDispatchDriver
{
public:
	CDaCtlCommands(){} // Calls COleDispatchDriver default constructor
	CDaCtlCommands(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDaCtlCommands(const CDaCtlCommands& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
